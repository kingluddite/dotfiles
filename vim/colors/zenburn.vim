...
if exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
    ...
    hi MatchParen    guifg=#ff0000 guibg=#383838 gui=bold  ctermfg=229 ctermbg=237 cterm=bold
    ...
    hi MatchParen    guifg=#ff0000 guibg=#2e2e2e gui=bold  ctermfg=145 ctermbg=236 cterm=bold
